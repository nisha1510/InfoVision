...
public class UserServiceImpl {
	...
	public UserDto getUser(String id) {
        return toDTO(repo.findById(id).orElseThrow(() -> new RuntimeException("User not found")));
    }
	
	public UserDto getUserByEmail(String email) {
        return toDTO(repo.findByEmail(email).orElseThrow(() -> new RuntimeException("User not found")));
    }
	
	public UserDto getUserByPhone(String phone) {
        return toDTO(repo.findByPhone(phone).orElseThrow(() -> new RuntimeException("User not found")));
    }
